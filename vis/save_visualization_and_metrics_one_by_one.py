...
# # test_name='./logs_validation/pretrained_diffusion/BAIR/bair64_DM_Batch64_lr2.e-4_c2p5_STW_adaptor_multi_traj_resume_flowdiff_0064_S190000_9000_100'
# # test_name='./logs_validation/pretrained_diffusion/BAIR/bair64_DM_Batch64_lr2e-4_c2p4_STW_adaptor_scale0.50_multi_traj_flowdiff_best_315.362_10000_100'
# test_name='./logs_validation/pretrained_diffusion/BAIR/bair64_DM_Batch64_lr2e-4_c2p10_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_best_239.058_2000_100'
# # test_name='./logs_validation/pretrained_diffusion/BAIR/bair64_DM_Batch66_lr2.e-4_c2p7_STW_adaptor_multi_traj_ada_flowdiff_0066_S095000_9000_100'
# num_frames_cond = 2
# num_frames_pred = 28
# size = 64
# we_have_video=100

# test_name="./logs_validation/pretrained_diffusion/KTH/kth64_DM_Batch32_lr2e-4_c10p4_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_best_355.236_1000_100"
# test_name="./logs_validation/pretrained_diffusion/KTH/kth64_DM_Batch32_lr2e-4_c10p5_STW_adaptor_multi_traj_ada_flowdiff_0032_S098000_7000_100"
# test_name="./logs_validation/pretrained_diffusion/KTH/kth64_DM_Batch32_lr2e-4_c10p20_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_0032_S075000_3000_100_not_random"
# test_name="./logs_validation/pretrained_diffusion/KTH/kth64_DM_Batch32_lr2e-4_c10p20_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_0032_S103000_1234_50"
# # test_name="./logs_validation/pretrained_diffusion/KTH/kth64_DM_Batch64_lr2e-4_c10p10_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_0064_S088000_1234_50"
# num_frames_cond = 10
# num_frames_pred = 40
# size = 64
# we_have_video=50

# # test_name='./logs_validation/pretrained_diffusion/Cityscapes/cityscapes128_DM_Batch40_lr1.5e-4_c2p5_STW_adaptor_scale0.25_multi_traj_ada_flowdiff_best_181.577_1234_50'
# test_name='./logs_validation/pretrained_diffusion/Cityscapes/cityscapes128_DM_Batch40_lr1.5e-4_c2p7_STW_adaptor_scale0.25_multi_traj_ada_flowdiff_best_1000_100'
# # test_name='./logs_validation/pretrained_diffusion/Cityscapes/cityscapes128_DM_Batch40_lr1.5e-4_c2p7_STW_adaptor_scale0.25_multi_traj_ada_flowdiff_best_1234_50'
# num_frames_cond = 2
# num_frames_pred = 28
# size = 128
# we_have_video=50

# test_name='./logs_validation/pretrained_diffusion/SMMNIST/smmnist64_DM_Batch40_lr2e-4_c10p10_STW_adaptor_multi_1248_flowdiff_0040_S195000_1000_50'
# # test_name='./logs_validation/pretrained_diffusion/SMMNIST/smmnist64_DM_Batch32_lr2.0e-4_c5p5_STW_adaptor_multi_124_resume_flowdiff_0036_S265000_1000_50'
# # test_name='./logs_validation/pretrained_diffusion/SMMNIST/smmnist64_DM_Batch32_lr2.0e-4_c5p5_STW_adaptor_multi_124_resume_flowdiff_0036_S265000_1000_50'
# num_frames_cond = 10
# num_frames_pred = 10
# size = 64
...
# test_name="./logs_validation/pretrained_diffusion/UCF101/ucf101_100"
test_name="./logs_validation/pretrained_diffusion/UCF101/ucf101_64_DM_Batch32_lr2e-4_c4p8_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_0032_S064000_707.41_1234_50"
# test_name="./logs_validation/pretrained_diffusion/UCF101/ucf101_64_DM_Batch54_lr2e-4_c4p4_region64_resume_flowdiff_0054_S048500_606.898_1234_50"
# test_name="./logs_validation/pretrained_diffusion/UCF101/ucf101_64_DM_Batch16_lr2e-4_c4p4_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_best_707.009_1000_10"
# test_name="./logs_validation/pretrained_diffusion/UCF101/ucf101_64_DM_Batch32_lr2e-4_c4p8_STW_adaptor_scale0.50_multi_traj_ada_flowdiff_0032_S064000_707.41_1234_1"
# test_name="./logs_validation/pretrained_diffusion/UCF101/ucf101_64_DM_Batch54_lr2e-4_c4p4_region64_resume_flowdiff_0054_S048500_606.898_1234_1"
num_frames_cond = 4
num_frames_pred = 16
size = 64
we_have_video=100
...
videos1 = torch.load(f'{test_name}/origin.pt').cuda()[:video_num,:num_frames_cond+num_frames_pred]

# 按每个轨迹单独计算
# for i in tqdm(range(num_sample_video)):
# for i in range(num_sample_video):
#     # print("="*5, i, "="*5)
#     videos2 = torch.load(f'{test_name}/result_{i}.pt').cuda()[:video_num,:num_frames_cond+num_frames_pred]
...
#     videos1 = torch.load(f'{test_name}/origin.pt')[:video_num,:num_frames_cond+num_frames_pred]
...
#     import random
#     id_list = random.sample(range(we_have_video),num_sample_video)
#     print(id_list)
#     cnt = 0
#     for i in tqdm(id_list):
#         videos = torch.load(f'{test_name}/result_{i}.pt')
#         # print(videos.shape)
#         # b t c h w -> b t h w
#         if videos.shape[2] == 3:
...
#         all_processed_videos[cnt] = videos[:,num_frames_cond:]
#         cnt += 1
#         del videos
#     # # n b t h w
