...
DATASET_PATH=/home/ubuntu/zzc/data/video_prediction/dataset_h5
SEED=1234
...
python ./scripts/diffusion/run.py \
    ...
    --device_ids 0,1,2,3 \
    --postfix DM_Batch40_lr2e-4_c10p20_STW_adaptor_scale0.50_multi_traj_ada \
    --checkpoint /home/ubuntu/zzc/code/EDM/logs_training/diffusion/KTH/kth64_DM_Batch40_lr2e-4_c10p20_STW_adaptor_scale0.50_multi_traj_ada/snapshots/flowdiff_best_366.854.pth \
    --set-start True
