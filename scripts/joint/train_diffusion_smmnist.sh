...
FLOWCKPT=/mnt/rhdd/zzc/data/video_prediction/flow_pretrained/better # u8
...
python ./scripts/diffusion/run.py \
    --set-start True \
    --flowae_checkpoint $FLOWCKPT/smmnist64/snapshots/RegionMM.pth \
    --checkpoint ./logs_training/diffusion/smmnist64_DM_Batch32_lr2e-4_c10p10/snapshots/flowdiff_0032_S135000.pth \
    --config ./logs_training/diffusion/smmnist64_DM_Batch32_lr2e-4_c10p10/smmnist64.yaml \
    --log_dir ./logs_training/diffusion \
    --device_ids 0,1 \
    --random-seed 1234 \
    --postfix DM_Batch32_lr2e-4_c10p10