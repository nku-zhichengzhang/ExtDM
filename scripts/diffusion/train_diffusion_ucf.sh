...
DATASET_PATH=/home/u1120230288/zzc/data/video_prediction/dataset/UCF101_h5
SEED=1234
...
CUDA_VISIBLE_DEVICES=0 \
python ./scripts/diffusion/run.py \
    --checkpoint /home/u1120230288/zzc/data/video_prediction/ExtraDM_pretrained/UCF101/ucf101_64_DM_Batch54_lr2e-4_c4p4_region64_resume/snapshots/flowdiff_0054_S048500_606.898.pth \
    --set-start True \
    --random-seed $SEED \
    --flowae_checkpoint $AE_CKPT/UCF101/$AE_NAME/snapshots/$AE_STEP.pth \
    --config ./config/ucf101_64.yaml \
    --log_dir ./logs_training/diffusion/ucf10164 \
    --device_ids 0 \
    --postfix DM_Batch54_lr2e-4_c4p4_region64_resume_lr_edited