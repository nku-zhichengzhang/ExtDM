# sh ./scripts/diffusion/valid_diffusion_smmnist1.sh
...
CUDA_VISIBLE_DEVICES=0 \
    ...
    --log_dir           ./logs_validation/pretrained_diffusion/SMMNIST/${DM_NAME}_${DM_STEP}_${SEED}_${NUM_SAMPLE}_with_flow_conf