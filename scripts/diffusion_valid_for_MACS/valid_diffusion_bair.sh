# sh ./scripts/diffusion_valid_for_MACS/valid_diffusion_bair.sh
...
DM_NAME=bair64_DM_Batch16_lr2e-4_c2p7_STW_adaptor_scale1.00_multi_traj_ada
DM_STEP=flowdiff_best_289.619
# SEED=2000
# NUM_SAMPLE=100
# NUM_BATCH_SIZE=2
SEED=1000
...
# bair64_FlowAE_Batch128_lr1e-4_Region20_affine_scale1.00
# RegionMM_best_63.302
# bair64_DM_Batch16_lr2e-4_c2p7_STW_adaptor_scale1.00_multi_traj_ada
# flowdiff_best_289.619
# - VideoFlowDiffusion_multi_w_ref
# - DenoiseNet_STWAtt_w_w_ref_adaptor_cross_multi_traj_ada
...
CUDA_VISIBLE_DEVICES=0 \
    ...
    --log_dir           ./logs_validation/pretrained_diffusion/BAIR/${DM_NAME}_${DM_STEP}_${SEED}_${NUM_SAMPLE}_for_MACS
