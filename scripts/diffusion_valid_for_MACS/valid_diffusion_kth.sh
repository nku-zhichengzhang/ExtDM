# sh ./scripts/diffusion_valid_for_MACS/valid_diffusion_kth.sh
...
# DM_NAME=kth64_DM_Batch32_lr1.5e-4_c10p10_STW_adaptor_scale1.00_multi_traj_ada
# DM_STEP=flowdiff_best_424.393
SEED=3000
NUM_SAMPLE=1
NUM_BATCH_SIZE=1
# SEED=1000
...
# kth64_DM_Batch32_lr1.5e-4_c10p10_STW_adaptor_scale1.00_multi_traj_ada
# flowdiff_best_424.393
# - VideoFlowDiffusion_multi_w_ref
# - DenoiseNet_STWAtt_w_w_ref_adaptor_cross_multi_traj_ada
...
train_pred_frames=79

while [ $train_pred_frames -le 80 ]
do
    echo $train_pred_frames
    CUDA_VISIBLE_DEVICES=0 \
        python ./scripts/diffusion_valid_for_MACS/valid_for_MACS.py \
        --train_pred_frames $train_pred_frames \
        ...
        --log_dir           ./logs_validation/pretrained_diffusion/KTH/${DM_NAME}_${DM_STEP}_${SEED}_${NUM_SAMPLE}_for_MACS
    train_pred_frames=$((train_pred_frames + 1))
done
