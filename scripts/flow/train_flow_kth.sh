...
#     --device_ids 0,1 \
#     --random-seed 1234 \
#     --postfix FlowAE_Batch256_lr2e-4_Region20_affine_Max20_SplitedData

# 预训练
python ./scripts/flow/run.py \
    --checkpoint ./logs_training/flow/kth64_FlowAE_Batch256_lr2e-4_Region20_affine_Max20_SplitedData/snapshots/RegionMM.pth \
    --config ./logs_training/flow/kth64_FlowAE_Batch256_lr2e-4_Region20_affine_Max20_SplitedData/kth64.yaml \
    --log_dir ./logs_training/flow \
    --device_ids 0,1 \
    --postfix FlowAE_Batch256_lr2e-4_Region20_affine_Max20_SplitedData \
    --random-seed 1234 \
