# sh ./scripts/LFDM/valid_diffusion_bair.sh
...
AE_STEP=RegionMM
DM_NAME=bair64_origin_LFDM_Batch64_lr2e-4_c2p5
DM_STEP=flowdiff_0064_S037500_217.167
SEED=1000
NUM_BATCH_SIZE=256
...
do
    ...
    python ./scripts/LFDM/valid.py \
        ...
        --log_dir ./logs_validation/LFDM/BAIR/${DM_NAME}_${SEED} \
        --config $DM_CKPT/BAIR/$DM_NAME/bair64_origin.yaml \
