...
from model.PVDM.vit_modules import TimeSformerEncoder, TimeSformerDecoder
...
class ViTAutoencoder(nn.Module):
    ...
    #              ):
        ...
        # self.image_key = model_params["image_key"]
...
# import torch
# model = ViTAutoencoder(is_train=False, config="/home/u1120230288/zzc/code/video_prediction/EDM/config/PVDM/ucf101_64_pvdm.yaml")
# model.cuda()
# input = torch.ones((1,3,16,256,256)).cuda()
